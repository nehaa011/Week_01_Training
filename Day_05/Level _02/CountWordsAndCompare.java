...
//Q-2 Write a program to split the text into words, compare the result with the split() method and display the result
//Create a class name CountWordsAndCompare
...
public class CountWordsAndCompare {
	...
	public static void main(String[] args) {
		...
		// checking if comapre array returns true value then if case will run otherwise
		// the else case will run
		if (isEqual) {
