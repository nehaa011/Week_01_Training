...
//Q-5 Write a program to find vowels and consonants in a string and display the count of  Vowels and Consonants in the string
//Create a class name VowelAndConsonantCount
...
public class VowelAndConsonantCount {
	...
	public static int[] countVowelConsonant(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			...
			// invoke checkCharacterType method to check if character is vowel, consonant or
			// not a letter
