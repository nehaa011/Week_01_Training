/*Ques 2 :Create a program to find the maximum number of handshakes among N number of students.
 */

//import the scanner class to take user input
import java.util.Scanner;

//create a MaximumHandShakes class to calculate the total no. of handshakes
public class MaximumHandShakes {
    ...
    public static void main(String[] args) {
        ...
        // create an intance of MaximumHandShakes class
